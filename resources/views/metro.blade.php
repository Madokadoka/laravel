...
<head>
    ...
    <title>Электрички</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{ asset('css/styles.css') }}">
</head>
<body
background="/img/1696589022_gas-kvas-com-p-kartinki-elektrichka-26.jpg">
...
<div class="tickets">
    ...
    <input type="date">
   <span> <button><a href="/raspisanie-electro">Показать расписание</a></button></span>
</div>
<footer>
